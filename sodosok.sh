#!/bin/bash
#shadowsocks-libev obfs install by JAVpala Community
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/jhall031/testkdn/main/addss.sh"
wget -O delss "https://raw.githubusercontent.com/jhall031/testkdn/main/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/jhall031/testkdn/main/cekss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/jhall031/testkdn/main/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/jhall031/testkdn/main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
